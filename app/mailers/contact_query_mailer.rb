...
# We capture the email of the persone that contacted us from the "form_message.email" (user's email who contacted us)
# Finally we add the email's subject we want our contacter to see on the email we'll send to them 
      ...
      mail(to: @form_message.email, 
            subject: 'Thank you for contacting Listis') #Setting the subject of the email we are sending 
